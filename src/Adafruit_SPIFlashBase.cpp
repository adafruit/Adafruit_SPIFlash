...
#if SPIFLASH_DEBUG
  #define SPIFLASH_LOG(_address, _count)   do { \
        Serial.print(__FUNCTION__); \
        Serial.print(": adddress = "); Serial.print(_address, HEX); \
...
Adafruit_SPIFlashBase::Adafruit_SPIFlashBase(Adafruit_FlashTransport* transport)
{
  _trans = transport;
  _flash_dev = NULL;
}
...
uint16_t Adafruit_SPIFlashBase::pageSize(void)
{
